...
public class JobCardConfirmationStep3 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jobcard_confirmation_step3);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent intent = new Intent(JobCardConfirmationStep3.this,
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                if (list.size() > 0) {
                                    for (int i = 0; i < lvReportedActivity.getCount(); i++) {
                                        ...
                                        dba.open();
                                        dba.updateJobCardPending(farmblockUniqueId, plantationUniqueId, tvJobCardDetailId.getText().toString(), String.valueOf(actValue.isChecked()));
                                        dba.close();
                                    }
                                    common.showToast("Details saved successfully.", 5, 3);
                                    Intent intent = new Intent(JobCardConfirmationStep3.this, PendingJobCard.class);
                                    intent.putExtra("farmerName", farmerName);
                                    intent.putExtra("farmerMobile", farmerMobile);
                                    intent.putExtra("farmblockUniqueId", farmblockUniqueId);
                                    intent.putExtra("farmblockCode", farmblockCode);
    ...
    private void BindData(String plantationUniqueId) {
        ...
        if (lsize > 0) {
            ...
            adapter = new CustomAdapter(JobCardConfirmationStep3.this, list);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_go_to_home:
                Intent intent1 = new Intent(JobCardConfirmationStep3.this,
                        ActivityHome.class);
