...
public class JobCardNurseryConfirmationDetail extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jobcard_nursery_confirmation_detail);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent intent = new Intent(JobCardNurseryConfirmationDetail.this,
    ...
    private void BindData(String plantationUniqueId) {
        ...
        if (lsize > 0) {
            ...
            adapter = new CustomAdapter(JobCardNurseryConfirmationDetail.this, list);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_go_to_home:
                ...
                Intent intent1 = new Intent(JobCardNurseryConfirmationDetail.this,
                        ActivityHome.class);
    ...
    public class CustomAdapter extends BaseAdapter {
        ...
        public View getView(final int arg0, View arg1, ViewGroup arg2) {
            ...
            if (arg1 == null) {
                arg1 = mInflater.inflate(R.layout.list_nursery_confirmed_activity, null);
