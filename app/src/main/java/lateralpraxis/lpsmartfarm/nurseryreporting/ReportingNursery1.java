...
public class ReportingNursery1 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reporting_nursery1);
        ...
        if (userRole.contains("Nursery Supervisor")) {
            radioMini.setVisibility(View.GONE);
            radioMain.setVisibility(View.VISIBLE);
        ...
        {
            radioMini.setVisibility(View.VISIBLE);
            radioMain.setVisibility(View.GONE);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent intent;
                intent = new Intent(ReportingNursery1.this, NurseryReportList.class);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                if ((spNursery.getSelectedItemPosition() == 0))
                    ...
                    //To move from ReportingNursery1 to ReportingNursery2 page
                    Intent intent = new Intent(ReportingNursery1.this, ReportingNursery2.class);
                    intent.putExtra("type", type);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_go_to_home:
                Intent homeScreenIntent = new Intent(ReportingNursery1.this, ActivityHome.class);
