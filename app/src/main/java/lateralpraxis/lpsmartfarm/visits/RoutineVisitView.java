...
public class RoutineVisitView extends Activity {
    final Context context = this;
    File fileFBook;
    CustomAdapter adapter;
    /*------------------------Start of code for controls Declaration------------------------------*/
    private TextView tvFarmer, tvMobile, tvFarmBlock, tvPlantation, tvAvgHeightPlant, tvPlantStatus,tvAgronomistVisitRecmd, tvEmpty;
    private ListView lvList;
    private View tvDivider;
    private SimpleDateFormat dateFormatter_display;
    private LinearLayout llDays;
    /*-------------------------Code for Variable Declaration---------------------------------------*/
    private List<VisitViewData> obj;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.routine_visit_view);
    ...
    /*-----------------Code to set Farm Block Unique Id--------------------------*/
        ...
        tvAgronomistVisitRecmd = (TextView) findViewById(R.id.tvAgronomistVisitRecmd);
     ...
     if(visitUniqueId != null) {
         ...
         tvFarmer.setText(obj.get(0).getFarmer());
         tvMobile.setText(obj.get(0).getMobile());
         ...
         if(!obj.get(0).getDays().equalsIgnoreCase("")) {
             ...
             tvAgronomistVisitRecmd.setText(obj.get(0).getDays());
         }
         else
         {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent intent = new Intent(RoutineVisitView.this, RoutineVisitList.class);
                startActivity(intent);
                finish();
                return true;
            case R.id.action_go_to_home:
                Intent homeScreenIntent = new Intent(RoutineVisitView.this, ActivityHome.class);
...
tvDivider.setVisibility(View.VISIBLE);
            ...
            adapter = new CustomAdapter(RoutineVisitView.this, list);
                    ...
                    try {
                        ...
                        if (fileFBook.isDirectory()) {
                            ...
                            for (int i = 0; i < fileList.length; i++) {
                                ...
                                Intent i1 = new Intent(RoutineVisitView.this,
                                        ViewImage.class);
                        ...
                        common.showAlert(RoutineVisitView.this, "Error: " + except.getMessage(), false);
                    }
                }
            });
